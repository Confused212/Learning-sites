...
var btnForm = document.querySelector('input[name=btn-form]');
var btnHide = document.querySelector('input[name=btn-hide]');
...
btnRemove.addEventListener('mousedown', function() {
    ...
    btnHide.classList.remove('btn-up')
    btnHide.classList.add('btn-dwn')
});

btnRemove.addEventListener('mouseup', function() {
    btnHide.classList.add('btn-up')
    btnHide.classList.remove('btn-dwn')
});

btnForm.addEventListener('mousedown', function() {
    btnForm.classList.add('btn-down');
    btnForm.classList.remove('btn-up');

});

btnForm.addEventListener('mouseup', function() {
    btnForm.classList.remove('btn-down');
    btnForm.classList.add('btn-up');

});

playStore.addEventListener('mousedown', function() {
    playStore.classList.add('btn-down');
    playStore.classList.remove('btn-up');

});

playStore.addEventListener('mouseup', function() {
    playStore.classList.remove('btn-down');
    playStore.classList.add('btn-up');

});

appStore.addEventListener('mousedown', function() {
    appStore.classList.add('btn-down');
    appStore.classList.remove('btn-up');

});

appStore.addEventListener('mouseup', function() {
    appStore.classList.remove('btn-down');
    appStore.classList.add('btn-up');
